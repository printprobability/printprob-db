...
find pages/ -regextype posix-extended -regex '.+([0-9]{3}|r)\.tif' > ~/$1_imagefiles.txt
cd ~

rsync -avh --files-from ~/$1_imagefiles.txt /pylon5/hm560ip/mpwillia/line_extractions/complete/$1/ bridges@printprobdb.library.cmu.edu:/vol/images/mpwillia/line_extractions/complete/$1/
