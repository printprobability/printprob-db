# Generated by Django 2.2.5 on 2019-10-03 16:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_early', models.DateField(default=datetime.date(1550, 1, 1))),
                ('date_late', models.DateField(default=datetime.date(1800, 12, 12))),
            ],
            options={
                'ordering': ['pq_title'],
            },
