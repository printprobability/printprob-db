...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Book',
            fields=[
                ('estc', models.PositiveIntegerField(help_text='ESTC ID number', primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('basename', models.CharField(help_text='Standard identifier using the printer/id/location schema, without any filetype name', max_length=500)),
            ],
            options={
                'ordering': ['basename'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_split_x', models.PositiveIntegerField(help_text='X-axis index marking the location of the page split on the spread image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filepath', models.CharField(help_text='relative file path to root directory containing all images', max_length=2000)),
