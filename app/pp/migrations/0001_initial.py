# Generated by Django 2.2.3 on 2019-07-19 01:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf', models.CharField(help_text='relative file path to root directory containing pdfs', max_length=2000, unique=True)),
            ],
            options={
                'ordering': ['estc'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(help_text='Image depicting this spread', on_delete=django.db.models.deletion.CASCADE, related_name='depicts_spread', to='pp.Image')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='depicts_page', to='pp.Image')),
        ...
        migrations.AddField(
            model_name='line',
            name='image',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='depicts_line', to='pp.Image'),
        ),
        migrations.AddField(
            model_name='line',
            name='page',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_run', models.ForeignKey(help_text='Which pipeline run created this object instance', on_delete=django.db.models.deletion.CASCADE, related_name='characters', to='pp.CharacterRun')),
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='depicts_character', to='pp.Image')),
